...
public class AddInvoiceCustomerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (existingPurchase != null) {
             ...
             // Call the InvoiceTemplate to generate the PDF
                ...
                String filePath = "C:\\Users\\HP\\eclipse-workspace\\Account_Manangement\\target\\invoice.pdf"; 
     ...
     // Call the InvoiceTemplate to generate the PDF
        InvoiceTemplate1 invoiceTemplate = new InvoiceTemplate1();
        String filePath = "C:\\Users\\HP\\eclipse-workspace\\Account_Manangement\\target\\invoice.pdf"; // Specify the file path to save the PDF
